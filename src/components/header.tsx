  ...
  return (
    <header
      className={cn(
        ...
        "w-full mx-auto backdrop-blur",
        isScrolled
          ? "bg-background/80 border-b border-border supports-[backdrop-filter]:bg-background/90"
          : "bg-background/10 supports-[backdrop-filter]:bg-background/10"
      )}
    >
      <Navbar {...menuData} />
    </header>
